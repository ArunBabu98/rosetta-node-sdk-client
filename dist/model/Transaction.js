...
var _RelatedTransaction = _interopRequireDefault(require("./RelatedTransaction"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('related_transactions')) {
          obj['related_transactions'] = _ApiClient["default"].convertToType(data['related_transactions'], [_RelatedTransaction["default"]]);
        }
