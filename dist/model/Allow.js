    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('block_hash_case')) {
          obj['block_hash_case'] = _ModelCase["default"].constructFromObject(data['block_hash_case']);
        }
        if (data.hasOwnProperty('transaction_hash_case')) {
          obj['transaction_hash_case'] = _ModelCase["default"].constructFromObject(data['transaction_hash_case']);
        }
      }
      return obj;
    }
...
/**
 * @member {module:model/ModelCase} block_hash_case
 */
Allow.prototype['block_hash_case'] = undefined;

/**
 * @member {module:model/ModelCase} transaction_hash_case
 */
