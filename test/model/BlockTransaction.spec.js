...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RosettaNodeSdkClient.BlockTransaction();
  });
  ...
  describe('BlockTransaction', function() {
    it('should create an instance of BlockTransaction', function() {
      // uncomment below and update the code to test BlockTransaction
      //var instane = new RosettaNodeSdkClient.BlockTransaction();
      //expect(instance).to.be.a(RosettaNodeSdkClient.BlockTransaction);
    });
