...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RosettaNodeSdkClient.NetworkIdentifier();
  });
  ...
  describe('NetworkIdentifier', function() {
    it('should create an instance of NetworkIdentifier', function() {
      ...
      //var instane = new RosettaNodeSdkClient.NetworkIdentifier();
      //expect(instance).to.be.a(RosettaNodeSdkClient.NetworkIdentifier);
    });
