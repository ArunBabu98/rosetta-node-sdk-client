...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RosettaNodeSdkClient.NetworkRequest();
  });
  ...
  describe('NetworkRequest', function() {
    it('should create an instance of NetworkRequest', function() {
      ...
      //var instane = new RosettaNodeSdkClient.NetworkRequest();
      //expect(instance).to.be.a(RosettaNodeSdkClient.NetworkRequest);
    });
