...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RosettaNodeSdkClient.ConstructionParseRequest();
  });
  ...
  describe('ConstructionParseRequest', function() {
    it('should create an instance of ConstructionParseRequest', function() {
      // uncomment below and update the code to test ConstructionParseRequest
      //var instane = new RosettaNodeSdkClient.ConstructionParseRequest();
      //expect(instance).to.be.a(RosettaNodeSdkClient.ConstructionParseRequest);
    });
