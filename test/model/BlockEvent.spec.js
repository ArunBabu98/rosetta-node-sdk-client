...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RosettaNodeSdkClient.BlockEvent();
  });
  ...
  describe('BlockEvent', function() {
    it('should create an instance of BlockEvent', function() {
      // uncomment below and update the code to test BlockEvent
      //var instane = new RosettaNodeSdkClient.BlockEvent();
      //expect(instance).to.be.a(RosettaNodeSdkClient.BlockEvent);
    });
