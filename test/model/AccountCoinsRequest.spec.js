...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RosettaNodeSdkClient.AccountCoinsRequest();
  });
  ...
  describe('AccountCoinsRequest', function() {
    it('should create an instance of AccountCoinsRequest', function() {
      ...
      //var instane = new RosettaNodeSdkClient.AccountCoinsRequest();
      //expect(instance).to.be.a(RosettaNodeSdkClient.AccountCoinsRequest);
    });
