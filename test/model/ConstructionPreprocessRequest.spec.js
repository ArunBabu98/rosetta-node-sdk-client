...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RosettaNodeSdkClient.ConstructionPreprocessRequest();
  });
  ...
  describe('ConstructionPreprocessRequest', function() {
    it('should create an instance of ConstructionPreprocessRequest', function() {
      // uncomment below and update the code to test ConstructionPreprocessRequest
      //var instane = new RosettaNodeSdkClient.ConstructionPreprocessRequest();
      //expect(instance).to.be.a(RosettaNodeSdkClient.ConstructionPreprocessRequest);
    });
