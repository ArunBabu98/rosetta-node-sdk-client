...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RosettaNodeSdkClient.MempoolTransactionRequest();
  });
  ...
  describe('MempoolTransactionRequest', function() {
    it('should create an instance of MempoolTransactionRequest', function() {
      ...
      //var instane = new RosettaNodeSdkClient.MempoolTransactionRequest();
      //expect(instance).to.be.a(RosettaNodeSdkClient.MempoolTransactionRequest);
    });
