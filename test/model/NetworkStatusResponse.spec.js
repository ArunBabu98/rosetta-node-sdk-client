...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RosettaNodeSdkClient.NetworkStatusResponse();
  });
  ...
  describe('NetworkStatusResponse', function() {
    it('should create an instance of NetworkStatusResponse', function() {
      ...
      //var instane = new RosettaNodeSdkClient.NetworkStatusResponse();
      //expect(instance).to.be.a(RosettaNodeSdkClient.NetworkStatusResponse);
    });
