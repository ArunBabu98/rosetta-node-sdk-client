...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RosettaNodeSdkClient.ConstructionPreprocessResponse();
  });
  ...
  describe('ConstructionPreprocessResponse', function() {
    it('should create an instance of ConstructionPreprocessResponse', function() {
      ...
      //var instane = new RosettaNodeSdkClient.ConstructionPreprocessResponse();
      //expect(instance).to.be.a(RosettaNodeSdkClient.ConstructionPreprocessResponse);
    });
