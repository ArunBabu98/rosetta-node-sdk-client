...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RosettaNodeSdkClient.BlockTransactionRequest();
  });
  ...
  describe('BlockTransactionRequest', function() {
    it('should create an instance of BlockTransactionRequest', function() {
      ...
      //var instane = new RosettaNodeSdkClient.BlockTransactionRequest();
      //expect(instance).to.be.a(RosettaNodeSdkClient.BlockTransactionRequest);
    });
