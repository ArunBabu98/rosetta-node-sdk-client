...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RosettaNodeSdkClient.BlockRequest();
  });
  ...
  describe('BlockRequest', function() {
    it('should create an instance of BlockRequest', function() {
      ...
      //var instane = new RosettaNodeSdkClient.BlockRequest();
      //expect(instance).to.be.a(RosettaNodeSdkClient.BlockRequest);
    });
