...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RosettaNodeSdkClient.OperationStatus();
  });
  ...
  describe('OperationStatus', function() {
    it('should create an instance of OperationStatus', function() {
      ...
      //var instane = new RosettaNodeSdkClient.OperationStatus();
      //expect(instance).to.be.a(RosettaNodeSdkClient.OperationStatus);
    });
