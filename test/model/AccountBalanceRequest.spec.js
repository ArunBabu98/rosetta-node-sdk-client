...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RosettaNodeSdkClient.AccountBalanceRequest();
  });
  ...
  describe('AccountBalanceRequest', function() {
    it('should create an instance of AccountBalanceRequest', function() {
      ...
      //var instane = new RosettaNodeSdkClient.AccountBalanceRequest();
      //expect(instance).to.be.a(RosettaNodeSdkClient.AccountBalanceRequest);
    });
