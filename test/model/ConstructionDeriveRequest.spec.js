...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RosettaNodeSdkClient.ConstructionDeriveRequest();
  });
  ...
  describe('ConstructionDeriveRequest', function() {
    it('should create an instance of ConstructionDeriveRequest', function() {
      // uncomment below and update the code to test ConstructionDeriveRequest
      //var instane = new RosettaNodeSdkClient.ConstructionDeriveRequest();
      //expect(instance).to.be.a(RosettaNodeSdkClient.ConstructionDeriveRequest);
    });
