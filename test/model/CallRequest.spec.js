...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RosettaNodeSdkClient.CallRequest();
  });
  ...
  describe('CallRequest', function() {
    it('should create an instance of CallRequest', function() {
      // uncomment below and update the code to test CallRequest
      //var instane = new RosettaNodeSdkClient.CallRequest();
      //expect(instance).to.be.a(RosettaNodeSdkClient.CallRequest);
    });
