...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RosettaNodeSdkClient.SearchTransactionsResponse();
  });
  ...
  describe('SearchTransactionsResponse', function() {
    it('should create an instance of SearchTransactionsResponse', function() {
      ...
      //var instane = new RosettaNodeSdkClient.SearchTransactionsResponse();
      //expect(instance).to.be.a(RosettaNodeSdkClient.SearchTransactionsResponse);
    });
