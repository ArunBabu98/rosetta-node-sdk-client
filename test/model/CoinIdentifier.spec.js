...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RosettaNodeSdkClient.CoinIdentifier();
  });
  ...
  describe('CoinIdentifier', function() {
    it('should create an instance of CoinIdentifier', function() {
      ...
      //var instane = new RosettaNodeSdkClient.CoinIdentifier();
      //expect(instance).to.be.a(RosettaNodeSdkClient.CoinIdentifier);
    });
