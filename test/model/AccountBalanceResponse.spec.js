...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RosettaNodeSdkClient.AccountBalanceResponse();
  });
  ...
  describe('AccountBalanceResponse', function() {
    it('should create an instance of AccountBalanceResponse', function() {
      ...
      //var instane = new RosettaNodeSdkClient.AccountBalanceResponse();
      //expect(instance).to.be.a(RosettaNodeSdkClient.AccountBalanceResponse);
    });
