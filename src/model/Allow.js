    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('block_hash_case')) {
                obj['block_hash_case'] = ModelCase.constructFromObject(data['block_hash_case']);
            }
            if (data.hasOwnProperty('transaction_hash_case')) {
                obj['transaction_hash_case'] = ModelCase.constructFromObject(data['transaction_hash_case']);
            }
        }
        return obj;
    }
